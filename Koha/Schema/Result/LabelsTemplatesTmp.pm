use utf8;
package Koha::Schema::Result::LabelsTemplatesTmp;
...
Koha::Schema::Result::LabelsTemplatesTmp
...
=head1 TABLE: C<labels_templates_tmp>

=cut

__PACKAGE__->table("labels_templates_tmp");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:nKXVovddoEVb2FcB+9pCLQ
