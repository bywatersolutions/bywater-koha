use utf8;
package Koha::Schema::Result::CreatorTemplatesTmp;
...
Koha::Schema::Result::CreatorTemplatesTmp
...
=head1 TABLE: C<creator_templates_tmp>

=cut

__PACKAGE__->table("creator_templates_tmp");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:GFeUQeNMBHoer4Bxj7ikgQ
