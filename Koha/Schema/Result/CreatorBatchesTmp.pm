use utf8;
package Koha::Schema::Result::CreatorBatchesTmp;
...
=head1 TABLE: C<creator_batches_tmp>

=cut

__PACKAGE__->table("creator_batches_tmp");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:DcmIkC4vbeqoeLGA0o8xmA
