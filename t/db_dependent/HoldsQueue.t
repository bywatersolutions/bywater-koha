...
my ( $queue, $total ) = C4::HoldsQueue::GetHoldsQueueItems({ branchlimit => $least_cost_branch_code});
...
subtest "GetHoldsQueueItems" => sub {
    ...
    ( $queue_items ) = C4::HoldsQueue::GetHoldsQueueItems({itemtypeslimit => $item_1->itype, ccodeslimit => $item_2->ccode});
