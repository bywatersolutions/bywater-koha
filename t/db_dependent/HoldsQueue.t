...
subtest "GetHoldsQueueItems" => sub {
    ...
    my ( $queue_items, $queue_total ) = GetHoldsQueueItems();
    is( $queue_total, $count + 3, 'Three items added to queue' );

    ( $queue_items, $queue_total ) = GetHoldsQueueItems( { itemtypeslimit => $item_1->itype } );
    is(
        $queue_total,
    ...
    ( $queue_items, $queue_total ) = GetHoldsQueueItems(
        {
